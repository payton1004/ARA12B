...
ps=/Users/jung-ok/work1/ARA12B/figure/station_ARA12B.ps
png=/Users/jung-ok/work1/ARA12B/figure/station_ARA12B.png
...
# No. 2, St.084
awk -F, '{if (NR==88) print $1, $2}' $data | 
gmt psxy -R -J -Sc0.20 -Ggreen -Wfaint,black  -O -V -K >> $ps

# No. 2, St.085
awk -F, '{if (NR==89) print $1, $2}' $data | 
gmt psxy -R -J -Sc0.20 -Ggreen -Wfaint,black  -O -V -K >> $ps
