...
pco2='/Users/jung-ok/work1/'$cruise'/processed/'$folder_name'/anom03/gps_hydroc_pco2_10min.csv'
...
ps=/Users/jung-Ok/work1/ARA12B/figure/spatial/ARA12B_hydroc_pco2.ps
png=/Users/jung-Ok/work1/ARA12B/figure/spatial/ARA12B_hydroc_pco2.png
...
awk -F, '{if (NR>1) print $2, $3, $4}' $pco2 | gmt psxy -R -J -Ccolor.cpt -Sc0.25 -O -K >> $ps
