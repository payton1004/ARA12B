...
mf = pd.concat(map(functools.partial(pd.read_csv, delimiter=','), 
            sorted(glob.glob('/Users/jung-ok/work1/'+cruise+'/processed/'+folder_name+'/'+subfolder_name+'/'+'chl'+'/anom02/'+'20*.csv')))) 

_file = '/Users/jung-ok/work1/'+cruise+'/processed/'+folder_name+'/'+subfolder_name+'/'+'chl'+'/anom02/'+'chl_flag.csv'
