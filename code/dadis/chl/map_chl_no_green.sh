...
ps=/Users/jung-Ok/work1/ARA12B/figure/spatial/ARA12B_Chl_no_green.ps
png=/Users/jung-Ok/work1/ARA12B/figure/spatial/ARA12B_Chl_no_green.png
...
#ARA12B
#track
awk -F, '{if (NR>1) print $2, $3}' $track  | gmt psxy -R -J -Wthick,orange -O -V -K >> $ps
