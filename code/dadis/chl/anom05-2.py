...
fname='chl_flag.csv'
# fname=input('fname = ')
_file ='/Users/jung-ok/work1/'+cruise+'/processed/'+folder_name+'/'+subfolder_name+'/'+'chl'+'/anom04/'+fname
...
def save_anomal(day1: str, df: pd.DataFrame, wp: float):
    ...
    # fname=input('fname = ')
    _file = '/Users/jung-ok/work1/'+cruise+'/processed/'+folder_name+'/'+subfolder_name+'/'+'chl'+'/anom05/'+fname
