...
data='/Users/jung-ok/work1/'$cruise'/processed/'$folder_name'/anom03/gps_optode_o2_10min.csv'
# pco2='/Users/jung-ok/work1/'$cruise'/processed/'$cruise'/anom03/pco2_10min.csv'
echo $data
...
ps=/Users/jung-Ok/work1/ARA12B/figure/spatial/ARA12B_optode_o2.ps
png=/Users/jung-Ok/work1/ARA12B/figure/spatial/ARA12B_optode_o2.png
...
# Optode
gmt makecpt -Cno_green -T350/465/5 > color.cpt
...
# color bar
gmt psscale  -D7.5i/2.8i/5.8i/0.17i -Ccolor.cpt -B50f10:"O@-2@- (\265M)": -O -V -K  >> $ps
# gmt psscale  -D3.55i/-0.5i/3.5i/0.15ih -CCO2_seawater.cpt -B50f10:"pCO@-2@- (\265atm) in seawater": -O -V -K  >> $ps
