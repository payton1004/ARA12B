...
_col='CO2 um/m'
_type='ATM'
data='/Users/jung-ok/work1/'$cruise'/processed/'$folder_name'/'$_type'/anom01/gps_go141_pco2_atm_1min.csv'
echo $data
...
ps=/Users/jung-Ok/work1/ARA12B/figure/spatial/ARA12B_go141_pco2_air.ps
png=/Users/jung-Ok/work1/ARA12B/figure/spatial/ARA12B_go141_pco2_air.png
...
# color bar
gmt psscale  -D7.5i/2.8i/5.8i/0.17i -Ccolor.cpt -B50f10:"xCO@-2@- (ppm) in air": -O -V -K  >> $ps
